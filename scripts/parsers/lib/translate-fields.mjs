...
export const INNER_PATH_RU = {
  General: 'Общий путь',
  'Bamboocut - Dust': 'Бамбуковый срез — Пыль',
  'Bamboocut - Wind': 'Бамбуковый срез — Ветер',
  'Bellstrike - Splendor': 'Удар колокола — Блеск',
  'Bellstrike - Umbra': 'Удар колокола — Тень',
  'Silkbind - Deluge': 'Шёлковая связь — Потоп',
  'Silkbind - Jade': 'Шёлковая связь — Нефрит',
  'Stonesplit - Might': 'Раскол камня — Мощь',
};
