            ...
            {user && (
              <div className="px-3 py-2.5 bg-ink-800/45 border-t border-ink-700/35 shrink-0 relative">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input value={text} onChange={e => setText(e.target.value)} placeholder="Сообщение... (BBCode: [b], [i], [url])" maxLength={1000}
          ...
          <div className="flex-1 overflow-y-auto p-3 min-h-0">
            {!user ? (
              ...
              <div className="space-y-3">
                ...
                <textarea value={text} onChange={e => setText(e.target.value)} rows={4} placeholder="Сообщение... (поддержка BBCode)" maxLength={1000}
