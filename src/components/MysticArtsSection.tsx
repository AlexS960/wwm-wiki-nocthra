...
export default function MysticArtsSection() {
  ...
  const [items, setItems] = useState(mysticArts);
              ...
              <div className="flex items-start gap-3 mb-3">
                ...
                {canManage && (
                  <div className="flex items-center gap-1">
                    <button onClick={() => setEditId(art.id)} className="px-2 py-1 rounded-lg text-[10px] text-gold-300 border border-gold-400/30 hover:bg-gold-400/10 cursor-pointer inline-flex items-center gap-1">
