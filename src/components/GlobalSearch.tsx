...
export default function GlobalSearch({ onNavigate }: GlobalSearchProps) {
  const { guides, wikiArticles, ensureWikiLoaded, ensureGuidesLoaded, searchGuidesRemote } = useAuth();
  ...
  useEffect(() => {
    ...
    setSearching(true);
    const t = setTimeout(() => {
      void searchSite(q, guideSource, wikiArticles, npcs).then(r => {
        if (active) {
          setResults(r);
          setSearching(false);
        }
  ...
  }, [query, guideSource, wikiArticles, npcs]);
