    ...
    <div className="space-y-6 animate-fadeIn max-w-2xl">
      <div className="bg-ink-800/50 border border-ink-700/30 rounded-xl p-5 space-y-4">
        ...
        <p className="text-ink-500 text-xs mt-2">
          Для скриншотов импортируйте коллекции из <code className="text-gold-400/80">pocketbase/pb_schema.json</code> и запустите PocketBase (см. <code className="text-gold-400/80">pocketbase/SETUP.ru.md</code>).
        </p>
