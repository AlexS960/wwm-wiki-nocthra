  ...
  return (
    ...
    >
      <div className="guild-banner-bg absolute inset-0 rounded-2xl overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-purple-950/35 via-violet-950/25 to-purple-950/45" />
        <div className="absolute inset-0 bg-[linear-gradient(110deg,transparent_0%,rgba(216,180,255,0.18)_45%,transparent_85%)] bg-[length:180%_180%] animate-[shimmer_7s_linear_infinite]" />
      </div>
...
function GuildInfoPopup({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  const modal = (
    <AppModal open={isOpen} onClose={onClose} layer="default" className="max-w-lg w-full">
      <div className="w-full max-h-[min(92dvh,720px)] sm:max-h-[90vh] rounded-t-2xl sm:rounded-2xl overflow-hidden shadow-2xl border border-purple-500/30 flex flex-col bg-[#1a1410]">
