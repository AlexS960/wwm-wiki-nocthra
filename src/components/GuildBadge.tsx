  ...
  return (
    ...
    >
      <div className="guild-banner-bg absolute inset-0 overflow-hidden" aria-hidden>
        <div className="absolute inset-0 opacity-40 bg-[linear-gradient(110deg,transparent_0%,rgba(216,180,255,0.2)_45%,transparent_85%)] bg-[length:180%_180%] animate-[shimmer_7s_linear_infinite]" />
      </div>
