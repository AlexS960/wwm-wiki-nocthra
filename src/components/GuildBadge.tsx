  ...
  return (
    ...
    >
      <div className="guild-banner-bg absolute inset-0 rounded-2xl overflow-hidden">
        <img src="/images/hero-bg.jpg" alt="" className="w-full h-full object-cover opacity-45" />
        <div className="absolute inset-0 bg-gradient-to-b from-purple-950/45 via-violet-950/40 to-purple-950/50" />
      </div>
