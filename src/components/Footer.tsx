...
export default function Footer() {
  ...
  const resources = [
    { label: 'Steam — Where Winds Meet', url: 'https://store.steampowered.com/app/3564740/Where_Winds_Meet/' },
    { label: 'Fextralife Wiki (EN)', url: 'https://wherewindsmeet.wiki.fextralife.com/' },
    { label: 'Game8 Wiki (EN)', url: 'https://game8.co/games/Where-Winds-Meet' },
    { label: 'Интерактивная карта', url: 'https://bgonegaming.win/wherewindmeets/' },
    { label: 'Reddit Сообщество', url: 'https://www.reddit.com/r/wherewindsmeet_/' },
    { label: 'Discord Nocthra', url: siteSettings.discordUrl },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 pt-6 border-t border-ink-800">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-ink-500 text-xs">© 2025 WWM Wiki — Русская База Знаний гильдии Nocthra.</p>
