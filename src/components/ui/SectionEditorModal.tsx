            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-ink-900/80 border border-ink-600/50 rounded-xl px-4 py-3 text-white text-sm placeholder:text-ink-500 focus:outline-none focus:border-gold-400/50 resize-y font-mono leading-relaxed min-h-[120px]"
                />
              </div>
            </div>
          )}
