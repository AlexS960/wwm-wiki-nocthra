...
import { CLOSE_ALL_OVERLAYS } from '../../lib/closeFloatPanels';
...
export default function AppModal({
  ...
  useEffect(() => {
    ...
    window.addEventListener(CLOSE_ALL_OVERLAYS, handler);
    return () => window.removeEventListener(CLOSE_ALL_OVERLAYS, handler);
  }, [open, onClose]);
