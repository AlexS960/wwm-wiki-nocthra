...
export default function InnerPathSection() {
  ...
  const pathFilters = useMemo(() => [
    ...
    ...paths.map(pathId => {
      ...
      return { value: pathId, label: `${meta.shortRu} (${countByPath[pathId] ?? 0})`, icon: meta.icon };
    }),
  ], [items.length, paths, countByPath]);
    ...
    <section id="innerpath" className="py-20 bg-ink-900/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 space-y-4">
          ...
          <FilterPills options={pathFilters} active={filterPath} onChange={setFilterPath} />
        </div>
