...
export default function CookingSection() {
  ...
  const categoryFilters = [
    ...
    { value: 'healing', label: 'Исцеление', icon: '❤️' },
    { value: 'buff', label: 'Баффы', icon: '⚡' },
  ];
  ...
  return (
    <section id="cooking" className="py-20 bg-pattern">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Filter */}
        <FilterPills options={categoryFilters} active={filterCategory} onChange={v => setFilterCategory(v as typeof filterCategory)} />
