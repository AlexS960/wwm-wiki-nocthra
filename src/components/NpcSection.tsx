...
import { aiChatGlobalTips, type AiNpc } from '../data/aiNpcs';
import { aiNpcRegionLabels } from '../data/aiNpcs';
...
export default function NpcSection() {
  ...
  const allNpcs = useMemo(() => mergeNpcList(wikiArticles), [wikiArticles]);
