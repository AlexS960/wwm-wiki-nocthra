...
import { Menu, X, Scroll, User, LogIn, House, BookOpenText, Users, CircleHelp, MessageSquare } from 'lucide-react';
...
export default function Header({ activeSection, onNavigate, onLoginClick, onProfileClick, showStaffChatLink }: HeaderProps) {
