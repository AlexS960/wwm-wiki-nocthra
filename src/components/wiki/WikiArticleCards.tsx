        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2">
            ...
            <div className="flex items-center gap-0.5 shrink-0" onClick={e => e.stopPropagation()}>
              {canEdit && (
                <>
                  <button type="button" onClick={onEdit} className="p-1.5 rounded-lg text-gold-400 hover:bg-gold-400/10 cursor-pointer">
                    <Edit3 className="w-3.5 h-3.5" />
                  </button>
                  <button type="button" onClick={onDelete} className="p-1.5 rounded-lg text-ink-500 hover:text-crimson-400 hover:bg-crimson-400/10 cursor-pointer">
