    ...
    <div className={`fixed left-4 sm:left-6 bottom-4 sm:bottom-6 z-50 transition-all duration-300 ${
      ...
      <div className="bg-ink-900/72 backdrop-blur-lg border border-gold-700/35 rounded-2xl shadow-2xl shadow-black/50 overflow-hidden flex flex-col"
        ...
        {!isMinimized && (
          <>
            {/* Messages */}
            <div className="flex-1 overflow-y-auto px-3 py-2 space-y-0.5" onClick={() => { setActionMenu(null); setShowEmojiPicker(false); setShowBbcodePicker(false); }}>
              {!user ? (
                  ...
                  <>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <input
                        ...
                        placeholder="Сообщение... (BBCode: [b]жирный[/b], [url]https://[/url])"
                        maxLength={500}
