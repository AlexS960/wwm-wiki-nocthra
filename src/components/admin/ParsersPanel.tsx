  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-ink-500 text-xs">
        На Vercel включите «Скачать свежий markdown с Game8» — файлы uploads/ в облаке могут отсутствовать.
        Диалоги NPC (<code className="text-ink-400">npcs-dialogues</code>) лучше через{' '}
        <code className="text-ink-400">npm run sync</code> локально.
      </p>
    </div>
  );
}
