        ...
        {lmGuideOpen && (
          <div className="px-5 pb-5 text-sm text-ink-300 space-y-4 border-t border-sky-500/10 pt-4">
            <p className="text-ink-400">
              LM Studio — бесплатная программа для Windows/Mac. «Сервер» — это не отдельный сайт, а кнопка внутри программы,
              которая открывает порт <code className="text-sky-300">1234</code> на вашем компьютере. Сайт обращается к нему только когда вы запускаете <code className="text-sky-300">npm run dev</code>.
            </p>
            ...
            <div>
              <h4 className="text-white font-medium mb-2">Шаг 4 — Запустить сервер (главное!)</h4>
              <ol className="list-decimal list-inside space-y-1 text-ink-400">
                <li>Слева нажмите иконку <strong className="text-ink-300">&lt;-&gt;</strong> или пункт <strong className="text-ink-300">Local Server</strong> / <strong className="text-ink-300">Developer</strong>.</li>
                <li>Убедитесь, что выбрана та же модель <code className="text-sky-300">ministral-3-3b</code>.</li>
                <li>Нажмите зелёную кнопку <strong className="text-emerald-400">Start Server</strong>.</li>
                <li>Должно появиться: <code className="text-sky-300">Server running on http://127.0.0.1:1234</code> — сервер работает.</li>
                <li>Если включили <strong className="text-ink-300">Require Authentication</strong> — токен <code className="text-sky-300">sk-lm-…</code> из Manage Tokens пропишите в <code className="text-sky-300">.env</code> как <code className="text-sky-300">LM_STUDIO_API_KEY</code>.</li>
                <li>Окно LM Studio не закрывайте, пока синхронизируете вики.</li>
              </ol>
            </div>
            ...
            <p className="text-ink-500 text-xs">
              Если имя модели в LM Studio отличается — скопируйте его из Local Server и вставьте в <code className="text-ink-400">.env</code> как{' '}
              <code className="text-ink-400">LM_STUDIO_MODEL=…</code>. На Vercel ИИ не работает — синхронизируйте только с ПК.
            </p>
          </div>
        )}
      </div>
