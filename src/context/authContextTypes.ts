...
export const defaultSiteSettings: SiteSettings = {
  ...
  roles: [
    ...
    { id: 'admin', displayName: 'Администратор', color: '#a882ff', permissions: ['read', 'profile', 'favorites', 'chat.write', 'chat.delete', 'chat.mute', 'chat.ban', 'staff.chat', 'support.view_all', 'support.reply', 'support.close', 'support.delete', 'guides.create', 'guides.edit', 'guides.delete', 'guild.edit', 'users.manage', 'users.ban', 'users.roles', 'site.settings', 'site.announcements', 'admin.panel'] },
  ],
...
export interface AuthContextValue {
  ...
  registerGuild: (name: string, description?: string, server?: string) => Promise<string | null>;
