...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const guildsHook = useAuthGuilds(user);
  ...
  const patchSiteSettings = (patch: Partial<typeof safeSiteSettings>) => {
    saveSite('site_settings', prev => mergeSiteSettingsSafe({ ...mergeSiteSettingsSafe(prev as typeof safeSiteSettings), ...patch }), siteCore.setSiteSettings);
  };
  ...
  const value: AuthContextValue = {
    ...
    registerGuild: guildsHook.registerGuild,
