...
export const DEFAULT_SECTION_CATEGORIES: Record<string, SectionCategoryDef[]> = {
  ...
  builds: [
    { id: 'Ближний ДПС', label: 'Ближний ДПС', icon: '⚔️' },
    { id: 'Ближний ДПС (DoT)', label: 'Ближний ДПС (DoT)', icon: '🩸' },
    { id: 'Ближний ДПС (Скорость)', label: 'Ближний ДПС (Скорость)', icon: '💨' },
    { id: 'Танк', label: 'Танк', icon: '🛡️' },
    { id: 'Целитель / Саппорт', label: 'Целитель / Саппорт', icon: '💚' },
    { id: 'Дальний ДПС', label: 'Дальний ДПС', icon: '🎯' },
    { id: 'PvE', label: 'PvE', icon: '🗺️' },
    { id: 'PvP', label: 'PvP', icon: '⚔️' },
    { id: 'Соло', label: 'Соло', icon: '🧍' },
    { id: 'Кооп', label: 'Кооп', icon: '👥' },
    { id: 'Универсальный', label: 'Универсальный', icon: '✨' },
    { id: 'Прочее', label: 'Прочее', icon: '✦' },
  ],
