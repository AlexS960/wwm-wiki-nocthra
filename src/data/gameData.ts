...
export const buildPaths: BuildPath[] = [
  ...
  { id: 'bellstrike-umbra', name: 'Bellstrike — Umbra', nameEn: 'Bellstrike — Umbra', role: 'Ближний ДПС (DoT)', weapons: ['Стратегический Меч', 'Копьё Небесного Грома'], description: 'Урон от эффектов кровотечения.', strengths: ['Стабильный урон'], weaknesses: ['Постепенный урон'], difficulty: 'Средняя', icon: '🩸', color: 'from-red-500/20 to-rose-600/20' },
  { id: 'bamboocut-wind', name: 'Bamboocut — Wind', nameEn: 'Bamboocut — Wind', role: 'Ближний ДПС (Скорость)', weapons: ['Инфернальные Парные Клинки', 'Смертельный Верёвочный Дротик'], description: 'Скоростные атаки и мобильность.', strengths: ['Скорость атаки'], weaknesses: ['Низкая выживаемость'], difficulty: 'Высокая', icon: '💨', color: 'from-cyan-500/20 to-teal-600/20' },
  { id: 'stonesplit-might', name: 'Stonesplit — Might', nameEn: 'Stonesplit — Might', role: 'Танк', weapons: ['Копьё Разрушителя Бурь', 'Клинок Грома'], description: 'Ориентирован на выживаемость и щиты.', strengths: ['Массивные щиты'], weaknesses: ['Низкий урон'], difficulty: 'Низкая', icon: '🛡️', color: 'from-stone-500/20 to-zinc-600/20' },
  { id: 'silkbind-deluge', name: 'Silkbind — Deluge', nameEn: 'Silkbind — Deluge', role: 'Целитель / Саппорт', weapons: ['Веер Панацеи', 'Зонт Тени Души'], description: 'Чистая поддержка и исцеление.', strengths: ['AoE-исцеление'], weaknesses: ['Нет урона'], difficulty: 'Средняя', icon: '💚', color: 'from-emerald-500/20 to-green-600/20' },
  { id: 'silkbind-jade', name: 'Silkbind — Jade', nameEn: 'Silkbind — Jade', role: 'Дальний ДПС', weapons: ['Чернильный Веер', 'Весенний Зонт'], description: 'Фокус на дальних атаках.', strengths: ['Дистанция'], weaknesses: ['Ближний бой'], difficulty: 'Высокая', icon: '🎯', color: 'from-purple-500/20 to-violet-600/20' },
];
