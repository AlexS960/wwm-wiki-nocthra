...
export function getPathMeta(pathEn: string): InnerPathMeta {
  return innerPathMeta[pathEn] ?? {
    ...
    shortRu: pathEn,
    icon: '✦',
    badgeClass: 'text-ink-300 bg-ink-700/50 border-ink-600/40',
  };
}
  ...
  innerWaysData.explainedRu?.length
    ...
    : [
        ...
        },
        {
          ...
          body: 'У каждого пути есть метка Path — он усиливает боевые искусства того же направления. Пути General универсальны и подходят любой сборке.',
        },
      ];
