        ...
        {isAdmin() && (
          <>
            <button onClick={() => onNavigate('admin')}
              className="fixed left-4 top-20 md:top-24 z-40 bg-ink-900/85 backdrop-blur-md border border-purple-500/35 rounded-xl p-3 shadow-xl shadow-black/40 hover:bg-purple-500/10 hover:border-purple-500/55 hover:-translate-y-0.5 transition-all cursor-pointer group" title="Панель управления">
...
function AnnouncementsFloating() {
  ...
  if (!isOpen) {
    return (
      <button onClick={() => setIsOpen(true)}
        className="fixed left-4 top-36 md:top-40 z-40 bg-ink-900/85 backdrop-blur-md border border-orange-500/35 rounded-xl p-3 shadow-xl shadow-black/40 hover:bg-orange-500/10 hover:border-orange-500/55 hover:-translate-y-0.5 transition-all cursor-pointer group" title="Объявления">
        <div className="w-9 h-9 rounded-xl bg-orange-500/20 flex items-center justify-center group-hover:scale-110 transition-transform">
  ...
  return (
    <div className="fixed left-4 top-36 md:top-40 z-50 w-80 animate-fadeIn">
