...
function AppContent() {
  ...
  if (siteSettings.maintenanceMode && !isAdmin()) {
    return (
      <div className="min-h-screen bg-ink-900/68 text-ink-100 page-enter">
        <Header {...headerProps} />
  ...
  if (currentPage === 'admin') {
    return (<div className="min-h-screen bg-ink-900/68 text-ink-100 page-enter"><Header {...headerProps} /><AdminPage onBack={goBack} /><Footer />{modals}</div>);
  }
  if (currentPage === 'faq') {
    return (<div className="min-h-screen bg-ink-900/68 text-ink-100 page-enter"><Header {...headerProps} /><div className="pt-16 md:pt-20"><FAQSection /></div><Footer />{modals}</div>);
  }
  if (currentPage === 'users') {
    return (<div className="min-h-screen bg-ink-900/68 text-ink-100 page-enter"><Header {...headerProps} /><UsersListPage onBack={goBack} /><Footer />{modals}</div>);
  }
  if (currentPage === 'wwmwiki') {
    return (<div className="min-h-screen bg-ink-900/68 text-ink-100 page-enter"><Header {...headerProps} /><WwmWikiPage onNavigate={handleNavigate} /><Footer />{modals}</div>);
  }
  if (contentPages.includes(currentPage)) {
    return (<div className="min-h-screen bg-ink-900/68 text-ink-100 page-enter"><Header {...headerProps} /><ContentPage pageId={currentPage} onBack={goBack} /><Footer />{modals}</div>);
  }
...
function MainPage({ headerProps, modals, onNavigate }: {
  ...
  return (
    <div className="min-h-screen bg-ink-900/62 text-ink-100">
      <Header {...headerProps} />
