...
const contentPages = ['weapons', 'builds', 'sects', 'bosses', 'mystic', 'map', 'cooking', 'tips', 'lifeskills', 'npcs', 'riddles', 'innerpath'];
...
function AppContent() {
  ...
  if (currentPage === 'wwmwiki') {
    return (<div className="min-h-screen bg-ink-900 text-ink-100 page-enter"><Header {...headerProps} /><WwmWikiPage onNavigate={handleNavigate} /><Footer />{modals}</div>);
  }
