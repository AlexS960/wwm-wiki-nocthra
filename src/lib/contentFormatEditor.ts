...
export const FORMAT_HELP = [
  ...
  'Ссылка на карточку вики: [url=/weapons#wiki-card-id]Название[/url] или [Название](/weapons#wiki-card-id)',
  'Кнопка «ссылка» на карточке копирует BBCode для вставки в текст',
