...
import type { AiNpc, AiNpcRegion, NpcDialogueLine } from '../data/aiNpcs';
import { aiNpcs as builtinNpcs } from '../data/aiNpcs';
...
export function mergeNpcList(wikiArticles: WikiArticle[]): AiNpc[] {
